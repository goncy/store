...
function SheetPortal({position, className, children, ...props}: SheetPortalProps) {
  return (
...
const sheetVariants = cva(
  "fixed z-50 scale-100 gap-4 bg-background p-4 opacity-100 shadow-lg border",
  {
    variants: {
      position: {
    ...
    compoundVariants: [
      ...
      },
      {
        position: ["right", "left"],
        size: "default",
        class: "w-full sm:w-1/3 sm:min-w-[480px] max-w-[540px]",
      },
      {
        position: ["right", "left"],
        size: "sm",
        class: "w-full sm:w-1/4 sm:min-w-[480px] max-w-[500px]",
      },
      {
        position: ["right", "left"],
        size: "lg",
